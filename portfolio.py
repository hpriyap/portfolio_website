...
st.markdown("""
    <div style="background-color: #2D2A32; padding: 60px 20px 80px 20px;">
        <h2 style="font-size: 48px; font-weight: 800; color: #F3A5C8; text-align: center; margin-bottom: 60px;">Education</h2>
    </div>
""", unsafe_allow_html=True)

# Now use Streamlit columns below the colored section
edu_col1, edu_col2 = st.columns(2)

with edu_col1:
    st.markdown("""
        <div class="fade-in" style="background-color: #F5F5F5; color: #171D1C; border-radius: 15px; padding: 30px; height: 100%%; box-shadow: 0 8px 24px rgba(0,0,0,0.3); margin-bottom: 40px;">
...
with edu_col2:
    st.markdown("""
        <div class="fade-in delay" style="background-color: #F5F5F5; color: #171D1C; border-radius: 15px; padding: 30px; height: 100%%; box-shadow: 0 8px 24px rgba(0,0,0,0.3); margin-bottom: 40px;">
